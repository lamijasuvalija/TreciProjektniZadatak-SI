...
const Db4Key = document.querySelector(".Cis");
const playDb4 = () => {
  playSound(Db4);
...
const Eb4Key = document.querySelector(".Dis");
const playEb4 = () => {
  playSound(Eb4);
...
const Gb4Key = document.querySelector(".Fis");
const playGb4 = () => {
  playSound(Gb4);
...
const Ab4Key = document.querySelector(".Gis");
const playAb4 = () => {
  playSound(Ab4);
...
const Bb4Key = document.querySelector(".Ais");
const playBb4 = () => {
  playSound(Bb4);
...
const B4Key = document.querySelector(".H");
const playB4 = () => {
  playSound(B4);
...
const C5Key = document.querySelector(".C2");
const playC5 = () => {
  playSound(C5);
...
const Db5Key = document.querySelector(".Cis2");
const playDb5 = () => {
  playSound(Db5);
...
const D5Key = document.querySelector(".D2");
const playD5 = () => {
  playSound(D5);
...
const Eb5Key = document.querySelector(".Dis2");
const playEb5 = () => {
  playSound(Eb5);
...
const E5Key = document.querySelector(".E2");
const playE5 = () => {
  playSound(E5);
